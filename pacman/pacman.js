...
function showGameOver(won) {
    ...
    title.className = won ? "game-over-title win" : "game-over-title";
...
function draw() {
    ...
    for (let food of foods.values()) {
        context.beginPath();
        context.arc(food.x + 2, food.y + 2, 3, 0, Math.PI * 2);
        context.fill();
    }
}
...
function movePacman(e) {
    if (gameOver) {
        return; // Use the overlay restart button instead
    }
